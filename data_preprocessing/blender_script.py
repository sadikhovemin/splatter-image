...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="/storage/group/dataset_mirrors/01_incoming/3DFront/3D-FUTURE-model/3062da49-9d90-3894-8c6a-207b131a7f1f/raw_model.obj",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
        ...
        default="/usr/prakt/s0091/github/splatter-image/data_preprocessing",
    )
    parser.add_argument(
        "--engine",
        type=str,
