...
CO3D_RAW_ROOT = "/storage/group/dataset_mirrors/01_incoming/CO3D"  # change to where your CO3D data resides
CO3D_OUT_ROOT = "/CO3D_processed"  # change to your folder here
