...
def main(
    ...
    model.eval()
    print("Loaded model!")
    print("training_cfg: ", training_cfg.data.category)

    # override dataset in cfg if testing objaverse model
    if (
        training_cfg.data.category == "objaverse"
        or training_cfg.data.category == "front3d"
    ) and split in ["test", "vis"]:
    ...
    print("checking datalaoder: ", dataloader == None)
